...
% wegen der Zyklen kann DSL nicht unter HEAD sein. Deswegen muss DSL explizit entlang des Kopfpfades nach oben gegeben werden.
headed_phrase *> (loc:dsl:DSL,
                  head_dtr:loc:dsl:DSL).
...
(headed_phrase,
 head_dtr:(word,
           phon:ne_list)) *> head_dtr:loc:dsl:none.
