...
jagt  ---> @np_np_verb(jagen_rel).

kenne ---> @np_np_verb(kennen_rel).

kennt ---> @np_np_verb(kennen_rel).

liebt ---> @np_np_verb(lieben_rel).

nimmt ---> @np_np_verb(nehmen_rel).

gab   ---> @np_np_np_verb(geben_rel).

gibt  ---> @np_np_np_verb(geben_rel).
