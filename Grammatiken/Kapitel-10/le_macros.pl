...
% schlafen, Satzkomplemente gibt es erst ab Kapitel 13
arg1_verb *>
 (%non_scopal_verb_word,
  loc:cat:arg_st:[ @xp(Ind) |_ ],
  rels:[arg1:Ind]).

% kennen, helfen, denken an
arg2_verb *>
 (%non_scopal_verb_word,
  loc:cat:arg_st:[ _, @xp(Ind) |_ ],
  rels:[arg2:Ind]).

% geben, bezichtigen
arg3_verb *>
 (%non_scopal_verb_word,
  loc:cat:arg_st:[ _, _, @xp(Ind) |_ ],
  rels:[arg3:Ind]).
...
np_np_np_verb *>
 (%arg123_verb
  loc:cat:arg_st:[ @np(nom,_), @np(dat,_), @np(acc,_)  ]).

np_np_np_verb(Relation) :=
 (np_np_np_verb,
  rels:hd:Relation).
