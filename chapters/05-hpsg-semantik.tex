...
die Variable x in h8:besitzen(x,y) ungebunden ist (Abbildung~\ref{Abbildung dessen Kind-falsch-x-ungebunden}). h3 müsste sowohl mit h9:lachen(x) als auch mit
...
Im Abschnitt~\ref{Abschnitt-rs-sem-Analyse} wird die Analyse vorgestellt, die die korrekte MRS
liefert. 
\begin{figure}
