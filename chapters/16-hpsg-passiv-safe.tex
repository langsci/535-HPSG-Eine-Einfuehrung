...
Argumentrealisierungsprinzip in (\mex{1}) teilt die \argstl eines Wortes in Subjekt, Spezifikator und Komplemente
auf.\footnote{%
...
\noindent
Dadurch, dass das Subjekt in der Ausgabe der Regel spezifiziert ist, muss es auf der \argstl
des Eingabeverbs eine NP mit strukturellem Kasus geben. Die jeweils erste kasusrelevante XP 
wird zum Element der \subjl. Durch die Spezifikation in der Lexikonregel sind Satzsubjekte
ausgeschlossen und es kommt nur eine NP mit strukturellem Kasus in Frage.
Da unakkusativische Verben kein designiertes
...
Der semantische Beitrag des Adjektivstamms wird per Konvention zum Lexikonelement des flektierten Adjektivs
...
\noindent
(\mex{1}) wiederholt die vereinfachte Form des Argumentrealisierungsprinzip, das bereits auf
S.\,\pageref{Prinzip-Argumentrealisierung-einfach-SUBJ} verwendet wurde:
\ea
\label{Prinzip-Argumentrealisierung-einfach-SUBJ-zwei}%
Argumentrealisierungsprinzip\is{Prinzip!Argumentrealisierungs-} (vereinfachte Version):\\[2pt]
\type{word} \impl
